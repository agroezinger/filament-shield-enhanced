...
Then run the standard generator to create the permissions in the database:
...
After publishing the RoleResource with `php artisan shield:publish --panel=admin`, open the generated file and replace the standard pages tab content:
